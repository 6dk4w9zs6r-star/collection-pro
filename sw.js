const CACHE='mf-nexa-shell-20260916-r5';
const APP=['./','./index.html','./manifest.webmanifest','./nexa-mf-icon.svg','./app.html','./mf-update-20260916.js','./mf-collaboration-20260916.js','./mf-recovery-20260916.js','./mf-messaging-20260916.js'];
